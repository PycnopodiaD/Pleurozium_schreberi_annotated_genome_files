...
est_gff=est2genome.gff,est_gff_stringtie.gff #aligned ESTs or mRNA-seq from an external GFF3 file
...
rm_gff=repeatmasker.gff,repeatrunner.gff #pre-identified repeat elements from an external GFF3 file
prok_rm=0 #forces MAKER to repeatmask prokaryotes (no reason to change this), 1 = yes, 0 = no
softmask=1 #use soft-masking rather than hard-masking in BLAST (i.e. seg and dust filtering)

#-----Gene Prediction
snaphmm=snap.hmm #SNAP HMM file
gmhmm=genemark.hmm #GeneMark HMM file
augustus_species=pleurozium_schreberi #Augustus gene prediction species model
